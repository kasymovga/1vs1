...
CLASS(NexuizGameSettingsDialog) EXTENDS(NexuizRootDialog)
	...
	ATTRIB(NexuizGameSettingsDialog, intendedWidth, float, 0.8)
	ATTRIB(NexuizGameSettingsDialog, rows, float, 10)
	ATTRIB(NexuizGameSettingsDialog, columns, float, 16)
...
void fillNexuizGameSettingsDialog(entity me)
{
	entity e;
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Show names:"));
	...
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Show names view sector:"));
		me.TD(me, 1, 2, e = makeNexuizTextSlider("cl_shownames_cos"));
			...
			e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Gun opacity:"));
		me.TD(me, 1, 2, e = makeNexuizSlider(0.05, 1, 0.05, "cl_gunalpha"));
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Damage indicator:"));
		me.TD(me, 1, 2, e = makeNexuizTextSlider("cl_damageindicator"));
			...
			e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Weapon bar fade time:"));
		me.TD(me, 1, 2, e = makeNexuizTextSlider("sbar_weapons_fadetime"));
			...
			e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 4, e = makeNexuizTextLabel(0, "Weapon bar fade speed:"));
