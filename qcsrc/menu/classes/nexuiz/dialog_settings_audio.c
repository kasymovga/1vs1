...
void fillNexuizAudioSettingsTab(entity me)
{
	...
	me.TR(me);
		...
		me.TD(me, 1, 0.9, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Music:")));
		me.TD(me, 1, 2, s);
	me.TR(me);
		me.TDempty(me, 0.1);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "voipvolume");
		me.TD(me, 1, 0.9, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Voice chat:")));
		me.TD(me, 1, 2, s);
	me.TR(me);
		me.TDempty(me, 0.1);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "volume");
		me.TD(me, 1, 0.9, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Effects:")));
		me.TD(me, 1, 2, s);
	me.TR(me);
		me.TDempty(me, 0.2);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "snd_staticvolume");
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Ambient:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_not_equal(e, "volume", "0");
		gui_set_dependent_not_equal(s, "volume", "0");
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2.8, e = makeNexuizCheckBox(0, "snd_perchannelvolumecontrol", _("Deprecated channel control")));
	me.TR(me);
		me.TDempty(me, 0.2);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "snd_worldchannel0volume");
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Info:")));
	...
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Items:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Pain:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Player:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Shots:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Voice:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Weapons:")));
		me.TD(me, 1, 2, s);
		gui_set_dependent_and(e, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
		gui_set_dependent_and(s, "volume", 0.01, 100, "snd_perchannelvolumecontrol", 0.01, 100);
	me.TR(me);
	...
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 1, 0.9, e = makeNexuizCheckBox(0, "snd_input_boost_auto", _("Automatic volume boost")));
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 1, 0.9, e = makeNexuizTextLabel(0, _("Volume boost:")));
	me.TR(me);
		me.TDempty(me, 1);
	...
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 1, 0.9, e = makeNexuizTextLabel(0, _("Microphone test:")));
		me.TD(me, 1, 0.75, e = makeNexuizCommandButton(_("Start"), '0 0 0', "snd_echo_start; _menu_echo_on 1", 0));
		gui_set_dependent(e, "_menu_echo_on", 0, 0);
		me.TD(me, 1, 0.75, e = makeNexuizCommandButton(_("Stop"), '0 0 0', "snd_echo_stop; _menu_echo_on 0", 0));
		gui_set_dependent(e, "_menu_echo_on", 1, 1);
