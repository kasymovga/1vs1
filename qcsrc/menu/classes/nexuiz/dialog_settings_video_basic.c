...
void fillNexuizVideoSettingsBasicTab(entity me)
{
	...
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 0.5, 1.9, e = makeNexuizTextLabel(0, _("* Can affect performance when not equal to 1 and GLSL gamma enabled")));
	...
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 0.5, 1.9, e = makeNexuizTextLabel(0, _("* Can affect performance when not equal to 1")));
		e.colorL = SKINCOLOR_TEXT_WARNING;
		e.fontSize = e.fontSize * 0.6;
	me.TR(me);
	...
	me.TR(me);
		me.TDempty(me, 0.1);
		me.TD(me, 0.5, 1.9, e = makeNexuizTextLabel(0, _("* From water, hurt and powerups")));
		e.colorL = SKINCOLOR_TEXT_WARNING;
		e.fontSize = e.fontSize * 0.6;
