...
void(entity me, entity btn) applyNexuizPlayerSettingsTab {
	localcmd("color -1 -1;name \"$_cl_name\";sendcvar cl_weaponpriority;sendcvar cl_zoomfactor;sendcvar cl_zoomspeed;sendcvar cl_autoswitch;sendcvar cl_shownames;sendcvar cl_gunalpha;sendcvar cl_gunalign;cl_gunalign_force_center;saveconfig\n");
