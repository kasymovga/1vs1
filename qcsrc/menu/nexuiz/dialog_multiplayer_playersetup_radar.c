...
void fillNexuizRadarDialog(entity me)
{
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 0.8, e = makeNexuizTextLabel(0, "Show names when aim:"));
		me.TD(me, 1, 3, e = makeNexuizTextSlider("cl_shownames"));
			...
			e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "hud_shownames", "Show names"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2.8, e = makeNexuizCheckBox(0, "hud_shownames_enemies", "Show enemy team names"));
